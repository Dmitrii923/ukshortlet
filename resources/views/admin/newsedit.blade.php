			...
			<section class="content mt-3">
				<div class="container-fluid">
               	@if ($errors->any())
					...
					<form name="" action="{{url('admin/newsupdate',$res->id)}}" method="post" enctype="multipart/form-data">
						@csrf
											...
											<div class="col-12">
												<div class="form-group">
													...
													<div class="input-group">
                                                        ...
                                                        id="adtitle"  name="title" autocomplete="off" value="{{$res->title}}" required>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													...
													<div>
														@if($res->pimg!='')
														<img style="height: 100px;width: 100px;" src="{{url('/')}}/uploadfile/{{$res->pimg}}">
