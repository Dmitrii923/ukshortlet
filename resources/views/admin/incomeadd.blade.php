			...
			<section class="content mt-3">
				<div class="container-fluid">
               	@if ($errors->any())
					...
					<form name="" action="{{url('admin/incomesave')}}" method="post" id="" enctype="multipart/form-data">
                    @csrf
							...
							<div class="col-md-12">
								<div class="card card-primary">
									<div class="card-header">
										<h3 class="card-title">Income Add</h3>
									</div>
									<div class="card-body">
										<div class="row">
											<div class="col-12">
										...
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													...
													<div class="input-group">
														<input type="text" name="milege" class="form-control">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													...
													<div class="input-group">
														<input type="number" name="taxpercent"   id="taxpercent" 
										...
										<div class="row">
											<div class="col-12">
												<div class="form-group">
													...
													<div class="input-group">
														<input type="text" id="totalamount" readonly name="totalamount" class="form-control">
													</div>
												</div>
											</div>
										</div>
