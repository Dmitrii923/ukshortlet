...
<div class="midArea innerArea">
	<div class="container">
		...
		<div class="contentArea">
			<h1 class="mb-4">FEATURED PROPERTIES IN {{$ptypename->typename}}</h1>
				...
				<div class="row align-items-center">
					...
					<div class="col-md order-md-2">
						<div>
							...
							<h5>Date Available: <?php echo date('m/d/Y',strtotime($prows->addate)); ?> | ROOMS | {{$ptypename->typename}} | Advert ID: UK100{{$prows->id}}</h5>
						</div>
					</div>
